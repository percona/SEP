...
export interface InventoryScheduleSummaryProps {
  /**
   * Whether scheduling is available for the plugin. When false the summary
...
/**
 * At-a-glance, plugin-level summary of inventory-sync schedules, surfaced on the
 * nodes page so users can see whether anything is scheduled without opening the
 * Schedules screen.
 *
 * Inventory's sync schedule is plugin-level (a single periodic task that may own
