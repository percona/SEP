...
import { TextInput, SelectInput, SwitchInput } from '@percona/percona-ui';
        ...
        <TextInput
          ...
          controllerProps={{
            rules: {
              ...(field.required && { required: `${field.label} is required` }),
              ...(field.ge !== undefined && {
                min: { value: field.ge, message: `Minimum value is ${field.ge}` },
              }),
              ...(field.le !== undefined && {
                max: { value: field.le, message: `Maximum value is ${field.le}` },
              }),
            },
          }}
        />
