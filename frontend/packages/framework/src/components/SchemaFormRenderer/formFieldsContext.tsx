...
const EMPTY_FIELDS: readonly AppField[] = Object.freeze([]);
 ...
 */
const FormFieldsContext = createContext<readonly AppField[]>(EMPTY_FIELDS);

export const FormFieldsProvider = FormFieldsContext.Provider;

export function useFormFields(): readonly AppField[] {
...
export function serviceTypesForDependsOn(
  ...
  if (parent?.type === 'service' || parent?.type === 'multi_service') {
