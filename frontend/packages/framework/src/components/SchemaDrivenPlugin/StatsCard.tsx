  ...
  return (
    <SectionShell>
      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
        ...
        <StatField label="Last Finished" value={formatRelative(data.last_finished_at)} />
        <StatField label="Avg Duration" value={formatSeconds(data.duration?.average_seconds)} />
        <StatField label="Last Duration" value={formatSeconds(data.duration?.last_seconds)} />
      </Box>
    </SectionShell>
  );
}
