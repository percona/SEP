...
describe('LogOutputPane with the real log renderer', () => {
              ...
              [
                {
                  ...
                  contentRect: {
                    width: 800,
                    height: target.classList.contains('react-lazylog') ? 400 : 19,
                  },
  ...
  it.each(['final\n', 'final\n\n', 'final', 'final\u0000'])(
    ...
    async (ending) => {
      ...
      act(() => {
        handle.pushMessage({ msg: 'first\nfi', step: 'setup', type: 'stdout', offset: 8 });
      });
      ...
      await waitFor(() =>
        expect(container.firstElementChild).toHaveAttribute('data-status', 'finished'),
      );
