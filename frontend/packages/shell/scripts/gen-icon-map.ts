 ...
 *
 * Usage:
 *   pnpm --filter @pmm-extensions/shell codegen
 */
...
const SPEC = path.resolve(HERE, '..', '..', 'api', 'specs', 'extensions.json');
const OUT_DIR = path.resolve(HERE, '..', 'src', 'generated');
const OUT = path.join(OUT_DIR, 'appNavIcons.ts');

const HEADER = [
  '/**',
  ' * This file is auto-generated by `pnpm --filter @pmm-extensions/shell codegen`.',
...
async function main(): Promise<void> {
  ...
  const body = [
    ...imports,
    '',
    "export const ICON_BY_KEY: Record<ExtensionsComponents['schemas']['nav_icons__NavIcon'], NavIcon> = {",
    ...entries,
    '};',
    '',
  ].join('\n');
