  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Open an incident to run diagnostic snippets and review their results in one place.
      </Typography>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleCreate} loading={createMutation.isPending}>
            Create
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent>
          ...
          <DialogContentText>
            Delete “{deleteTarget?.name}”? Its recorded executions are removed. This cannot be
            undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
