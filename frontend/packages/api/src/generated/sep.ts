...
export interface components {
  schemas: {
     ...
     *         set). Optional at the model layer for backwards compatibility, but
     *         required at runtime for any plugin whose ``task_type`` is set: the
     *         framework refuses to load a task-style plugin without it. Defaults
     *         to ``None``.
