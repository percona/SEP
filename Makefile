...
# textual expansion) supplies each value and embedded quotes, spaces and
# backticks stay literal. Interpolating "$(MSG)" instead pastes the raw text
# inside an already-open quoted string, where a `"` closes it and a backtick
