...
"""Hold the Inventory track's autogenerate quiet about a store where beat has run."""
...
def test_autogenerate_ignores_the_beat_tables(inventory_alembic_config):
    """Keep the schedule tables out of the Inventory track's proposed operations."""
