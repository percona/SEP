...
TASK_NAME = "extensions__sync_snippets"
...
async def test_reseed_preserves_disabled_flag(mocker, beat_maker) -> None:
    ...
    await init_periodic_tasks_db(_schedule(every=10), "extensions__")
    ...
    await init_periodic_tasks_db(_schedule(every=30), "extensions__")
