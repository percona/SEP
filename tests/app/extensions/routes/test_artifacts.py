...
"""Define tests for the app.extensions.routes.artifacts module."""
...
from app.extensions.artifact_constants import (
    ARTIFACT_DOWNLOAD_SALT,
    STATIC_ARTIFACT_BASE_DIRS,
)
...
_SNIPPETS_DIR_TARGET = "app.extensions.snippets.config.snippets_settings.SNIPPETS_DIR"
...
class TestCollectBaseDirs:
    ...
    def test_raises_on_duplicate_artifact_type(self, mocker) -> None:
        ...
        mocker.patch(
            "app.extensions.routes.artifacts.get_app_registry",
    ...
    def test_does_not_mutate_the_static_map(self, mocker) -> None:
        ...
        mocker.patch(
            "app.extensions.routes.artifacts.get_app_registry", return_value=[declaring]
        )
...
class TestDownloadArtifact:
    ...
    def test_valid_dipper_token_existing_file_returns_200(self, test_client, tmp_path):
        ...
        with patch("app.extensions.apps.dipper.app.DIPPER_PAYLOADS_DIR", tmp_path):
            response = test_client.get(f"/artifacts/download/{token}")
    ...
    def test_expired_token_returns_400(self, test_client, tmp_path):
        ...
        with (
            patch(
                "app.extensions.routes.artifacts.extensions_settings.ARTIFACT_DOWNLOAD_TTL",
                60,
            ),
