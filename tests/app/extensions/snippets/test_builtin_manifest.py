...
from app.extensions.snippets import builtin_manifest
from app.extensions.snippets.builtin_manifest import load_builtin_checksum_manifest
from app.extensions.snippets.checksums import BUILTIN_CHECKSUM_MANIFEST, sha256_file

MODULE = "app.extensions.snippets.builtin_manifest"
