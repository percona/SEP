...
from app.extensions.api.routes import delivery_connection
from app.extensions.api.routes.delivery_connection import DeliveryConnectionStatusEnum
from app.extensions.bundle_upload.plan import DeliveryPlan
from app.extensions.bundle_upload.resolver import DeliveryUnavailableCode
...
def configured_delivery(mocker: MockerFixture) -> None:
    ...
    mocker.patch.object(extensions_settings, "DIAGNOSTICS_DELIVERY", _delivery_plan())
...
class TestDeliveryConnectionEndpoint:
    ...
    def test_reports_drifted_inputs_separately_from_unconfigured(
        ...
        mocker.patch.object(
            extensions_settings, "DIAGNOSTICS_DELIVERY", _delivery_plan()
        )
        mocker.patch.object(
            extensions_settings,
