...
"""Tests for the PMM Extensions dashboard stats JSON API route at ``/api/extensions/dashboard/``."""
...
from app.extensions.api.constants import UPSTREAM_ERROR_HEADER
...
def mock_session_dep() -> Iterator[AsyncMock]:
    ...
    extensions_app.dependency_overrides[get_session] = lambda: mock
    yield mock
