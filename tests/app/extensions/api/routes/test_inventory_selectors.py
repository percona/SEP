...
"""Tests for PMM Extensions inventory selector JSON API routes under ``/api/extensions/``."""
...
class TestExtensionsServiceSchemasEndpoint:
...
class TestExtensionsSchemaTablesEndpoint:
