...
from app.extensions.apps.alters.form_backfill import reconstruct_alters_form
from app.extensions.apps.alters.models import AltersCreate
from app.extensions.apps.archives.form_backfill import reconstruct_archives_form
from app.extensions.apps.archives.models import ArchivesCreate
from app.extensions.apps.backup_pg.form_backfill import reconstruct_backup_pg_form
from app.extensions.apps.backup_pg.models import BackupPgForm
from app.extensions.apps.checksums.form_backfill import reconstruct_checksums_form
...
from app.extensions.apps.mysql_backups.form_backfill import (
    LegacyBackupCreate,
...
def _patch_collector_import(mocker: MockerFixture, module: MagicMock) -> None:
    ...
    """
    mocker.patch(
        "app.extensions.apps.framework.form_backfill_registry.import_module",
        return_value=module,
    )
...
def test_collects_every_declared_entry_from_the_default_activation():
    ...
    entries = collect_form_backfill_entries(extensions_settings.APPS)
