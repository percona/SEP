...
class TestAssembleEnvelopeAlertDetailBuilder:
    ...
    def test_alert_detail_builder_stamped_when_set(self) -> None:
        ...
        write = assemble_envelope(
            ...
            name="task-1",
            owner="ARCHIVER",
            alert_detail_builder="app.extensions.apps.pkg.mod:builder",
        )

        assert write.alert_detail_builder == "app.extensions.apps.pkg.mod:builder"
...
class TestAssembleEnvelopeRunResultRecorder:
    ...
    def test_run_result_recorder_stamped_when_set(self) -> None:
        ...
        write = assemble_envelope(
            ...
            name="task-1",
            owner="BACKUPS",
            run_result_recorder="app.extensions.apps.pkg.mod:recorder",
        )

        assert write.run_result_recorder == "app.extensions.apps.pkg.mod:recorder"
