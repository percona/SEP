...
from app.extensions.apps.framework import make_parent_resolver, make_task_dep
from app.extensions.deps import get_tasks_api
...
class TestMakeTaskDep:
    ...
    async def test_delegates_to_get_task_by_name_with_owner(self, mocker) -> None:
        ...
        get_task_by_name = mocker.patch(
            "app.extensions.apps.framework.deps.get_task_by_name",
