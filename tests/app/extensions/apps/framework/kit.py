...
from app.extensions.apps.framework.responses import build_default_task_response
...
from app.extensions.deps import TaskAPI
...
class MockTaskAPI:
    ...
    :func:`~app.extensions.apps.framework.task_status.batch_get_latest_statuses` — the
...
class SynthResponse(BaseModel):
    ...
    contract as :class:`~app.extensions.apps.framework.responses.BaseTaskResponse`),
