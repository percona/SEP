...
"""Define tests for the app.extensions.apps.alters.deps module."""
...
from app.extensions.apps.alters.deps import (
...
from tests.app.extensions.apps.alters.factories import AltersCreateFactory
...
async def test_cascade_update_alters_group_halt_by_default(mocker):
    ...
    original_build = __import__(
        "app.extensions.apps.framework.cascade", fromlist=["build_predecessor_payload"]
    ...
    mocker.patch(
        "app.extensions.apps.alters.deps.build_predecessor_payload",
...
async def test_cascade_update_pairs_predecessor_names_with_specs(mocker):
    ...
    try:
        ...
        original_build = __import__(
            "app.extensions.apps.framework.cascade",
            fromlist=["build_predecessor_payload"],
        ).build_predecessor_payload
        ...
        mocker.patch(
            "app.extensions.apps.alters.deps.cascade_update_tasks",
            new=AsyncMock(
                return_value=__import__(
                    "app.extensions.apps.framework.cascade", fromlist=["CascadeResult"]
                ).CascadeResult()
            ),
        )
