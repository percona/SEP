...
"""Define tests for the app.extensions.apps.report.celery module."""
...
import app.extensions.apps.report.celery as report_celery
...
MODULE = "app.extensions.apps.report.celery"
