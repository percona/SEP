...
"""Define tests for the app.extensions.apps.report.deps module."""
...
from app.extensions.apps.report import deps as report_deps
from app.extensions.apps.report.deps import (
    require_pmm_api,
)
...
class TestPmmDepReExports:
    """Assert the report PMM deps are re-exports of the ``app.extensions.deps`` originals."""
    ...
    def test_symbol_is_same_object_as_extensions_deps(self, name):
        ...
        """
        assert getattr(report_deps, name) is getattr(extensions_deps, name)
