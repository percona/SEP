...
from tests.app.extensions.apps.report.conftest import make_report

API_BASE = "/api/apps/report"
_API = "app.extensions.apps.report.api_routes"
...
def mock_pmm_api():
    ...
    extensions_app.dependency_overrides[require_pmm_api] = lambda: mock
    yield mock
    extensions_app.dependency_overrides.pop(get_pmm_api, None)
    extensions_app.dependency_overrides.pop(require_pmm_api, None)
