...
from app.extensions.apps.mysql_backups.restore.models import RestoreConfigAll

_RESTORE_DIR = (
    pathlib.Path(__file__).parents[6] / "app/extensions/apps/mysql_backups/restore"
)
