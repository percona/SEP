...
:data:`~tests.app.extensions.apps.archives.build_pins.ARCHIVES_DELETE_PINS` — a
...
from tests.app.extensions.apps.archives.build_pins import ARCHIVES_DELETE_PINS
