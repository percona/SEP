...
"""Define tests for the app.extensions.apps.alerts.loader module."""
...
from app.extensions.apps.alerts.loader import (
    get_alert_templates,
...
class TestGetAlertTemplates:
    ...
    def test_falls_back_to_default_dir_when_setting_is_none(self) -> None:
        ...
        with patch(
            "app.extensions.apps.alerts.loader.extensions_settings"
        ) as mock_settings:
