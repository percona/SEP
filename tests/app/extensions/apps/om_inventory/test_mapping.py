...
silent: :meth:`~app.extensions.sync.models.BaseTaskSyncer.get_task_target` falls back to an
...
from app.extensions.apps.om_inventory.mapping import map_service, map_services
