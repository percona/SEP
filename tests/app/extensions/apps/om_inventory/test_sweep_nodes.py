...
class TestTheColdStartRace:
    """Assert a sweep that starts before PMM Extensions' web server does not report a failure.
    ...
    PMM Extensions has the same race; the harness only makes it deterministic.
    """
