...
from app.extensions.deps import get_task_by_name
...
class TestTasksPluginListEndpoint:
    ...
    def _mock_username_mapping(self):
        ...
        with patch(
            "app.extensions.apps.tasks.api_routes.get_username_mapping",
...
class TestTasksPluginDetailEndpoint:
    ...
    def test_detail_returns_404_when_task_lookup_raises(
        ...
        extensions_app.dependency_overrides[get_task_by_name] = task_not_found
