...
"""Define tests for the app.extensions.sync.syncers.mysql.payload module."""
...
try:
    ...
    from app.extensions.sync.syncers.mysql.payload import (
...
def test_iter_tables(mock_cursor):
    ...
    with patch(
        "app.extensions.sync.syncers.mysql.payload.get_table"
    ) as mocked_get_table:
...
class TestMain:
    ...
    MODULE = "app.extensions.sync.syncers.mysql.payload"
