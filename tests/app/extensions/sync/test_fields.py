...
"""Define tests for the app.extensions.sync.fields module."""
...
from app.extensions.sync import syncers
...
def _syncer_classes() -> set[type[BaseSyncer]]:
    ...
    Every module under ``app.extensions.sync.syncers`` is imported first: subclass discovery
