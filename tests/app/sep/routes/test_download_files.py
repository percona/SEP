...
class TestListTaskHistoryFiles:
    ...
    def test_propagates_non_400_http_exceptions(
        self, test_client, mock_tasks_api_dep, task_history_response
    ):
        """Assert HTTP errors other than 400 are re-raised, not silently returned as {}."""
        mock_tasks_api_dep.get.side_effect = HTTPException(status_code=503)
