...
"""Tests for the backup_pg JSON API Pydantic models."""
...
def test_backup_task_write_rejects_extra_host_port_fields() -> None:
    """BackupTaskWrite rejects ``host``/``port`` so silent drops surface as 422.
...
def test_backup_task_detail_response_inherits_response_fields() -> None:
    """BackupTaskDetailResponse extends BackupTaskResponse without extras."""
