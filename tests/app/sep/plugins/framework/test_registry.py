...
class TestBespokeBaseAppDefinitions:
    """Cover the alert_troubleshooting/alerts/dipper/inventory/report ``BaseApp`` definition wiring."""
    ...
    def test_schemaless_plugins_have_no_app_schema(self, plugin: str) -> None:
        """Register the alert_troubleshooting, alerts, dipper, and report definitions without a schema."""
