...
class TestGetPmmApi:
    ...
    async def test_returns_none_when_endpoint_not_configured(self):
        ...
        with patch("app.sep.plugins.report.deps.sep_settings") as mock_settings:
    ...
    async def test_returns_client_when_configured(self):
        ...
        with (
            patch("app.sep.plugins.report.deps.sep_settings") as mock_settings,
            patch("app.sep.plugins.report.deps.settings") as mock_global_settings,
        ):
            mock_settings.PMM.endpoint = "https://pmm.example.com"
            mock_settings.PMM.api_key = "secret-key"
