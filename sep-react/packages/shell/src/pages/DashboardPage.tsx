...
const stats: StatCard[] = [
  ...
  { title: 'Alerts', value: 3, icon: NotificationsActiveIcon, color: 'error.main', to: '/alerts/templates' },
];
...
const recentTasks: RecentTask[] = [
  { id: 1, name: 'pt-online-schema-change', target: 'prod-db-01', status: 'running', started: '2 min ago' },
  { id: 2, name: 'xtrabackup', target: 'prod-db-03', status: 'completed', started: '15 min ago' },
  { id: 3, name: 'pt-table-checksum', target: 'staging-db-01', status: 'completed', started: '1 hour ago' },
...
export default function DashboardPage() {
  ...
  return (
    <>
      <Typography variant="h5" sx={{ fontFamily: '"Poppins", sans-serif', fontWeight: 500, mb: 0.5 }}>
        Dashboard
      </Typography>
