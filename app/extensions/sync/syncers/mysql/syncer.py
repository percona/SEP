...
from app.extensions.sync.models import BaseTaskSyncer, claim_identity, TaskRunResult
...
class MySQLSyncer(BaseTaskSyncer):
    """Synchronize MySQL inventory entities within the PMM Extensions application.
