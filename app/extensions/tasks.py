...
class PeriodicTaskRequest(BaseModel):
    """Define the base model for writing periodic tasks from the PMM Extensions app.
...
class PeriodicTaskCreateRequest(PeriodicTaskRequest):
    """Define the model for creating periodic tasks from the PMM Extensions app.
...
class EnhancedPeriodicTaskCreateRequest(PeriodicTaskCreateRequest):
    """Define a model for creating periodic tasks compatible with the PMM Extensions app form data.
