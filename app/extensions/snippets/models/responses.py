...
framework's :class:`~app.extensions.apps.framework.script_source.ScriptSource` seam;
...
from app.core.utils.fields import NonEmptyStr, UniqueList, UTCDatetime
from app.extensions.apps.framework.schema import AppDeploymentCapabilities
