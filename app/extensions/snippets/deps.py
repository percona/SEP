...
from app.extensions.apps.framework.script_helpers import build_execution_meta
...
def get_snippet_list_query(
    ...
    *,
    ...
    from :attr:`~app.extensions.snippets.crud.SnippetManager.list_query_spec`, so an
