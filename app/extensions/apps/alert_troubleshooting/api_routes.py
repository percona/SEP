...
from app.extensions.apps.alert_troubleshooting.deps import (
    get_grouped_alerts,
    get_snippets_for_alert,
)
from app.extensions.apps.alert_troubleshooting.models import (
    AlertDetailResponse,
    AlertGroup,
    AlertSummary,
)
from app.extensions.apps.alert_troubleshooting.schema import (
...
from app.extensions.models import AlertServiceType
from app.extensions.snippets.models.responses import build_snippet_response
