...
Lives alongside (not inside) :mod:`app.extensions.apps.framework` because both ends of an
existing one-way dependency need these spellings:
:mod:`app.extensions.apps.framework.script_helpers` imports
:mod:`app.extensions.snippets.models.snippet`, so nothing under ``app.extensions.snippets.models``
