...
from app.extensions.models import SyncStatusEnum
from app.extensions.utils.forms import (
    parse_crontab_form_fields,
    parse_interval_form_fields,
)
...
class InventorySyncScheduleCreateForm(BaseModel):
    ...
    :param syncer: Optional fully qualified syncer name (e.g.
        ``"app.extensions.sync.syncers.pmm.PMMSyncer"``). When set, the schedule
    ...
    def normalize_form(cls, data: Any) -> Any:
        ...
        :class:`app.extensions.tasks.PeriodicTaskRequest.set_period` (both reach into
        :mod:`app.extensions.utils.forms`) so the form accepts the exact same input
