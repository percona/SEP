...
:func:`~app.extensions.apps.mysql_backups.restore.deps.resolve_restore_entities`.
"""
...
from app.extensions.apps.mysql_backups.payload_variants import CANONICAL_PAYLOAD_NAME
