...
``app/extensions/api/router.py``. ``api_router`` applies session/Bearer auth;
...
from app.extensions.apps.report.artifact_store import artifact_exists, read_artifact
from app.extensions.apps.report.celery import (
    render_report_pdf_job,
    upload_report_snapshot_job,
)
from app.extensions.apps.report.config import health_report_settings
from app.extensions.apps.report.deps import RequiredPMMAPIDep
from app.extensions.apps.report.job_service import filter_report_sections
from app.extensions.apps.report.models import ReportJobResponse, ReportSnapshotWrite
from app.extensions.apps.report.service import generate_report
