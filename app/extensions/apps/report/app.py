...
from app.extensions.apps.report.api_routes import router as api_router
...
def _report_periodic_tasks() -> list[AppPeriodicTask]:
    ...
    for idx, entry in enumerate(health_report_settings.schedules):
        ...
        tasks.append(
            AppPeriodicTask(
                name=f"extensions__generate_health_report{suffix}",
    ...
    tasks.append(
        AppPeriodicTask(
            name="extensions__purge_report_artifacts",
