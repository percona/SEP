...
from app.extensions.models import AlertServiceType as ServiceType
...
def to_pmm_template_yaml(template: AlertTemplate) -> str:
    """Convert a PMM Extensions alert template to PMM template YAML format.

    :param template: The PMM Extensions alert template to convert.
