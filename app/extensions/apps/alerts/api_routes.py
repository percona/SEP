...
``app/extensions/api/router.py`` through the ``api_routes.py`` convention validator
in ``app/extensions/config.py``. Authentication is enforced at the ``api_router``
...
from app.extensions.apps.alerts.restore import (
