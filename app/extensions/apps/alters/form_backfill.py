...
from app.extensions.apps.alters.deps import parse_alters_task_args
from app.extensions.apps.alters.models import AltersCreate, OWNER
...
def reconstruct_alters_form(
    ...
    """Rebuild an :class:`~app.extensions.apps.alters.models.AltersCreate` body from a legacy task.
