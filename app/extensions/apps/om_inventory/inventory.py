...
"""List the MongoDB services the worker diagnoses, from PMM Extensions' inventory."""
...
class InventoryService:
    ...
    PMM's to derive, not PMM Extensions'; this app only has to find the service and probe its
    ...
    grouping services in PMM Extensions again.
