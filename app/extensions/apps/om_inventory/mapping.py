...
:meth:`~app.extensions.sync.models.BaseTaskSyncer.get_task_target` — node name first, then
...
service is :attr:`~app.extensions.apps.om_inventory.models.NodeResolution.ORPHANED` and is not
probed at all.
