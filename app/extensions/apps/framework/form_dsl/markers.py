...
from app.extensions.apps.framework.schema import HelpPlacement
...
class FieldWidget(StrEnum):
    ...
    A plain ``str`` maps to :class:`~app.extensions.apps.framework.schema.StringField`
...
class Ui:
    ...
    :param parent: Name of a sibling ``bool`` field, in the same section, that
        ...
        implies.
        :func:`~app.extensions.apps.framework.form_dsl.derivation.derive_form_sections`
...
class Option:
    ...
    :param value: The value submitted when the option is selected. Stringified
        to match :attr:`~app.extensions.apps.framework.schema.Choice.value`.
    ...
    :param disabled: When ``True``, the option is rendered non-selectable.
        ...
        consuming app's :class:`~app.extensions.apps.framework.rules.FormRules`
...
class SectionLayout:
    ...
    :param forbidden: Optional whole-section hide gates copied verbatim to
        :attr:`~app.extensions.apps.framework.schema.FormSection.forbidden`. This is
