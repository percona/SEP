...
:func:`~app.extensions.apps.framework.form_backfill_registry.collect_form_backfill_entries`,
...
:data:`~app.extensions.apps.framework.form_backfill_registry.StampRepairer`. A stamp is a
