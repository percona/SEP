...
:mod:`app.extensions.apps.atw.models` is loaded by the Alembic plugin-discovery loader
...
from app.extensions.snippets.script_source import snippet_source, SnippetScript
