...
:data:`~app.extensions.snippets.script_source.snippet_source`, while the
...
the library (``app.extensions.snippets.celery``), not this package, so the app owns no
...
``app.extensions.artifact_constants`` and resolves whether or not this app is
...
from app.extensions.apps.snippets.extra_routes import (
    approval_router,
    artifact_router,
    maintenance_router,
)
...
from app.extensions.snippets.script_source import snippet_source
