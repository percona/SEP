...
"""Look up the :class:`~app.extensions.apps.om_bootstrap.strategy.InstallStrategy` for a run.

The one place an :class:`~app.extensions.apps.om_bootstrap.strategy.InstallMethod` maps
...
from app.extensions.apps.om_bootstrap.strategies.packages import PackagesInstallStrategy
from app.extensions.apps.om_bootstrap.strategy import InstallMethod, InstallStrategy

__all__ = ["STRATEGIES", "strategy_for"]

#: Every implemented strategy, keyed by the :class:`InstallMethod` it handles.
#: Only :data:`~app.extensions.apps.om_bootstrap.strategy.InstallMethod.PACKAGES` has one
