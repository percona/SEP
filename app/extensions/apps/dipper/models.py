...
from app.extensions.apps.dipper.constants import CollectorTypeEnum, DIPPER_PAYLOADS_DIR
from app.extensions.apps.framework.script_source import ARBITRARY_ARGS_SCHEMA
...
class DipperScript(BaseSnippet):
    """Represent a Dipper payload script stored on the PMM Extensions server filesystem."""
