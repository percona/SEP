...
"""Filter ``alembic_version_extensions`` rows whose migration scripts are not loaded.
...
recorded in the shared ``alembic_version_extensions`` table. An image that strips an
