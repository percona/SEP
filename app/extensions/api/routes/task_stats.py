...
Expose the Tasks-service ``GET /stats/{task}`` aggregation through the PMM Extensions
gateway so the React frontend (``useTaskStats``) does not bypass the PMM Extensions
