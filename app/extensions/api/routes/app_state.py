...
both attached at the mount in :mod:`app.extensions.api.router`. See
:class:`app.extensions.models.AppState` for the underlying DB model and
:func:`app.extensions.deps.require_app_enabled` for the per-route guard that consumes
the state at request time. Apps in :data:`app.extensions.deps.PROTECTED_APP_KEYS`
...
from app.extensions.app_drain import finalize_drain_if_complete
...
from app.extensions.models import AppLifecycleEnum, AppStateBase, AppStateWrite
from app.extensions.periodic_tasks import apply_effective_enabled
