...
schema-driven service selectors without bypassing the PMM Extensions layer (see the
non-bypass rule in ``app/extensions/api/router.py``).
"""
...
from app.extensions.api.models import InventorySelectorOption, proxy_inventory_selector
...
async def list_services(
    ...
    """Return a paginated list of inventory services via the PMM Extensions gateway.
...
async def list_service_schemas(
    ...
    """Return schemas for a service via the PMM Extensions gateway.
