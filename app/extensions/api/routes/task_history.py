...
Expose task-history reads through the PMM Extensions gateway so the React frontend never
...
from app.extensions.api.task_history_merge import (
...
async def list_merged_task_history(
    ...
    * **provided, every name blank after trimming** -- reject with ``422``.
    ...
    if task_names is None:
        ...
        page = PaginatedResponse[ExtensionsTaskHistoryResponse].model_validate(payload)
    else:
