...
"""Shared OpenAPI response declarations for PMM Extensions proxy routes."""
...
"""OpenAPI ``responses=`` entry for a PMM Extensions proxy route's upstream-Tasks-API ``502``.

PMM Extensions proxy routes that forward to the Tasks sub-app re-raise a
``HTTPBadGatewayException`` on upstream Tasks-API failure. The PMM Extensions exception
