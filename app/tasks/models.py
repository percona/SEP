...
class Task(TaskBase, BaseSQLModel, table=True):
    ...
    created_by: UUID4 | None = SQLField(default=None)
    last_updated_by: UUID4 | None = SQLField(default=None)
...
class TaskHistory(TaskHistoryBase, BaseSQLModel, table=True):
    ...
    executed_by: UUID4 | None = SQLField(default=None)
