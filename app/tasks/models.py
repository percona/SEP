...
class Task(TaskBase, BaseSQLModel, table=True):
    ...
    :param anonymize_mask: The bitmask representing PII entities to be anonymized in
        logs and files generated by the task. Defaults to 0 (no anonymization).
    :type anonymize_mask: int
    :param created_by: The username of the user who created the task.
    :type created_by: str | None
    :param last_edit_by: The username of the user who last modified the task.
    :type last_edit_by: str | None
    """
    ...
    created_by: str | None = SQLField(default=None, index=True)
    last_edit_by: str | None = SQLField(default=None, index=True)
...
class TaskHistory(TaskHistoryBase, BaseSQLModel, table=True):
    ...
    :param executed_by: The username of the user who executed the task.
