...
:data:`~app.sep.plugins.snippets.script_source.snippet_source`, while the
...
from app.sep.plugins.snippets.extra_routes import (
    approval_router,
    artifact_router,
    maintenance_router,
)
from app.sep.plugins.snippets.models import SnippetsCapabilitiesResponse
from app.sep.plugins.snippets.routes import router as jinja_router
from app.sep.plugins.snippets.script_source import snippet_source
