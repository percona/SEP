...
hooks :func:`~app.sep.plugins.framework.api.derive_script_routes` needs to derive
that surface, so a :class:`~app.sep.plugins.framework.apps.TaskExecutionApp` can
