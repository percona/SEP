...
from app.sep.plugins.backup_pg.deps import parse_backup_task_data
from app.sep.plugins.backup_pg.models import BackupPgForm
...
def reconstruct_backup_pg_form(
    ...
    """Rebuild a :class:`~app.sep.plugins.backup_pg.models.BackupPgForm` body from a legacy task.

    Wraps :func:`~app.sep.plugins.backup_pg.deps.parse_backup_task_data`, resolves
