...
from app.sep.plugins.alert_troubleshooting.api_routes import router as api_router
from app.sep.plugins.alert_troubleshooting.routes import router as jinja_router
