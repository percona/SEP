...
from app.sep.plugins.mysql_backups.deps import parse_backup_task_data
from app.sep.plugins.mysql_backups.models import BackupCreate, UploadProvider
...
def reconstruct_mysql_backups_form(
    ...
    """Rebuild a :class:`~app.sep.plugins.mysql_backups.models.BackupCreate` body from a legacy task.

    Wraps :func:`~app.sep.plugins.mysql_backups.deps.parse_backup_task_data`, resolves
