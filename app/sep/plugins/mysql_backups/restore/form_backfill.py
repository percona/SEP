...
from app.sep.plugins.mysql_backups.restore.deps import parse_restore_task_data
...
def reconstruct_mysql_restores_form(
    ...
    """Rebuild a :class:`~app.sep.plugins.mysql_backups.restore.models.RestoreCreate` body from a legacy task.

    Wraps :func:`~app.sep.plugins.mysql_backups.restore.deps.parse_restore_task_data`,
